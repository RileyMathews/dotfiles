...
2. Re-read any plan and review files mentioned in the compaction summary to make sure you are re-focused on the actual plan as documented in the repository.
