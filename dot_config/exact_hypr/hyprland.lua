...
hl.bind(mainMod .. " + ALT + K", hl.dsp.exec_cmd("playerctl --player=kdeconnect play-pause"))
hl.bind(mainMod .. " + ALT + J", hl.dsp.exec_cmd("playerctl --player=kdeconnect position 10-"))
hl.bind(mainMod .. " + ALT + L", hl.dsp.exec_cmd("playerctl --player=kdeconnect position 10+"))
